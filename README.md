...
|---|---|---|
| 1 | `BX-09` | |
| 2–8 | `UX-15` `UX-21` `UX-17` `UX-03` `UX-11` `UX-16` `UX-01` | UX 系列 |
| 9–11 | `BX-35` `BX-48` `BX-23` | |
| 12 | `UX-20` | |
| 13–15 | `CX-19` `CX-08` `CX-18` | CX 系列 |
| 15 | `ドラグーンストーム` | BX-00 ブースター ドラグーンストーム4-60RA（BX-00 系列僅此款） |
| 16–18 | `BX-42` `BX-29` `BX-30` | |
